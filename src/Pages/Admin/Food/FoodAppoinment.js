...
const FoodAppoinment = () => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const response = await axios.get("/share_food/food_history");
          ...
          <div className="card">
            <div className="card-body">
              <div className="d-flex justify-content-between  ">
                <h5 class="mb-4 px-2">Food Appoinment List</h5>
                {/* pagination */}
                {/* Pagination starts */}
